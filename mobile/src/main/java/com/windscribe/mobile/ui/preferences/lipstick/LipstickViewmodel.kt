...
abstract class LipstickViewmodel : ViewModel() {
    ...
    abstract fun loadConnectedCustomBackground(
        context: Context,
        fileUri: Uri,
    )

    abstract fun loadDisconnectedCustomBackground(
        context: Context,
        fileUri: Uri,
    )

    abstract fun loadConnectedCustomSound(
        context: Context,
        fileUri: Uri,
    )

    abstract fun loadDisconnectedCustomSound(
        context: Context,
        fileUri: Uri,
    )

    abstract fun loadServerListFile(
        context: Context,
        fileUri: Uri,
    )
    ...
    abstract fun exportServerListFile(
        context: Context,
        uri: Uri,
    )
...
class LipstickViewmodelImpl
    ...
    constructor(
        ...
        private fun loadThemePreferences() {
            _themeItem.value = LookAndFeelHelper
                .getThemeOptions()
        ...
        override fun loadDisconnectedCustomBackground(
            context: Context,
            fileUri: Uri,
        ) {
            try {
        ...
        override fun loadConnectedCustomBackground(
            context: Context,
            fileUri: Uri,
        ) {
            try {
        ...
        override fun loadDisconnectedCustomSound(
            context: Context,
            fileUri: Uri,
        ) {
            try {
        ...
        override fun loadConnectedCustomSound(
            context: Context,
            fileUri: Uri,
        ) {
            try {
        ...
        override fun loadServerListFile(
            context: Context,
            fileUri: Uri,
        ) {
            try {
        ...
        override fun exportServerListFile(
            context: Context,
            uri: Uri,
        ) {
